  ...
  return (
    <div className="prose prose-zinc dark:prose-invert max-w-none">
      <div className="rounded-lg border bg-white dark:bg-zinc-900 p-6 md:p-8">
        ...
        <p className="mb-6">
          This Consent for AI Tracking & Insights Policy ("Policy") explains how IndieCrowdfund, a DBA of Divinity Comics Inc. ("IndieCrowdfund," "we," "our," "us") uses artificial intelligence ("AI"), machine-learning ("ML"), and automated analytics tools to improve user experience, detect fraud, enhance creator performance insights, and maintain platform safety.
        </p>
