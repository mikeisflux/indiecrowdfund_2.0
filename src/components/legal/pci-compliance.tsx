    ...
    <div className="prose prose-zinc dark:prose-invert max-w-none">
      <div className="rounded-lg border bg-white dark:bg-zinc-900 p-6 md:p-8">
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2">
          ...
          <li><strong>Browser-side tokenization (Mentom Payments):</strong> Mentom Payments uses Collect.js to tokenize card data directly in the backer&apos;s browser. The full card number is sent straight from the browser to Mentom Payments&apos;s vault — IndieCrowdfund servers receive only an opaque token</li>
        ...
        <h4 className="text-lg font-semibold mt-6 mb-3">Mentom Payments</h4>
        <p className="mb-6">
          Mentom Payments is a high-risk friendly merchant account on the NMI payment gateway. Card data is tokenized in the backer&apos;s browser via Collect.js before it ever leaves the page — only the resulting opaque token is sent to IndieCrowdfund. We pass the token to Mentom Payments&apos;s vault to charge the card on campaign success. IndieCrowdfund never receives, processes, or stores raw card data from Mentom Payments transactions, keeping these transactions out of our PCI scope. Mentom Payments and the underlying NMI gateway maintain their own PCI DSS Level 1 compliance.
        </p>
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2">
          ...
          <li>Use only PCI DSS compliant payment gateways (PayPal, Mentom Payments / NMI, DivinityCoin, Whop) for all card transactions</li>
        </ul>
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <li>Mentom Payments transactions tokenize your card directly in your browser via Collect.js — your card data never reaches IndieCrowdfund</li>
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2">
          <li>Funds are securely processed through your chosen payment processor (PayPal, Mentom Payments, DivinityCoin, or Whop)</li>
