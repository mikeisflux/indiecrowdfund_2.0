...
const tabContent: Record<string, TabContent> = {
  ...
  'transaction-history': {
    ...
    howTo: [
      ...
      { step: 'View transaction details', detail: 'Each transaction shows the payment processor used and the processor-specific transaction ID for debugging payment issues. New campaigns use PaymentCloud; existing campaigns may show legacy processors.' },
