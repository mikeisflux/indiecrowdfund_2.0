...
// Keep in sync with the headline scoreboard on the page. Backmebro shows "9+"
// because it has launched and 9 of our features are verified from its live
// site + Terms of Service; a handful of cells remain unverified (shown as "?").
const SCORES = [
  ...
  { name: "Backmebro", score: "9+", highlight: false },
];
