...
const tabContent: Record<string, TabContent> = {
  ...
  'faq': {
    ...
    steps: [
      ...
      { title: 'What happens if I file a chargeback or credit-card dispute?', description: 'File a chargeback or credit-card dispute against IndieCrowdfund or any of our payment processors and your account is permanently banned the moment the dispute is filed, regardless of outcome. You lose every pledge, reward, and digital download tied to that account, and any future accounts under the same email, payment method, IP, or device are also banned. Our ToS makes it explicit: rewards are not guaranteed, you back at your own risk, and a delayed or scaled-back campaign is not grounds for a chargeback. File = banned. No appeals.', tip: 'The only carve-outs are actual unauthorized-use fraud (card stolen) and regulator/law-enforcement directives. Everything else is the risk you accepted at checkout. See the full Chargeback Handling Policy at /terms?tab=chargebacks.' },
