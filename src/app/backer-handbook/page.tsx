...
const tabContent: Record<string, TabContent> = {
  ...
  'after': {
    ...
    steps: [
      ...
      { title: 'Locking Your Order', description: 'Some creators ask you to confirm and "lock" your order early — sometimes while the campaign is still live — so they can print and ship sooner. You\'ll get a "Confirm & lock your order" notification and email that opens an approval page. Review your reward, add-ons, and total, confirm your shipping address, then choose "Lock my order" or "I need to make changes first". Locking makes your reward, add-ons, and shipping address FINAL — they can no longer be changed — and you won\'t also receive the fulfillment survey. Depending on your payment method you may be charged when you lock: if you already paid you just lock, saved-card (Divinity Payments) backers are charged on lock, and PayPal/Whop backers are charged on the campaign\'s normal schedule.', tip: 'Double-check your shipping address and add-ons before you lock — once locked, you can\'t change them. Not ready? Choose "I need to make changes first" and you\'ll get the normal survey instead.' },
