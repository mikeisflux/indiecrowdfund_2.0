...
const tabContent: Record<string, TabContent> = {
  ...
  'faq': {
    ...
    steps: [
      ...
      { title: 'What happens if I file a chargeback or credit-card dispute?', description: 'Filing a chargeback or dispute against IndieCrowdfund or our payment processors instead of contacting support@indiecrowdfund.com first will result in an immediate permanent ban on your account, regardless of dispute outcome. You will lose access to every pledge, reward, and digital download tied to it, and future accounts under the same email/payment method/IP/device will also be banned. This is because our Terms of Service make clear that rewards are not guaranteed and you back at your own risk — a delayed or scaled-back campaign is not grounds for a chargeback.', tip: 'Always contact support first. We can usually resolve refund and fulfillment issues directly in a few business days. See the full Chargeback Handling Policy at /terms?tab=chargebacks.' },
