...
const tabContent: Record<string, TabContent> = {
  ...
  'marketplace': {
    ...
    steps: [
      ...
      { title: 'Making a Purchase', description: 'Click "Purchase" to checkout. Pay via PayPal, Mentom Payments, DivinityCoin, or Whop depending on the creator\'s chosen processor. Charged immediately.', tip: 'Unlike pledges, marketplace purchases are instant.' },
