...
const tabContent: Record<string, TabContent> = {
  ...
  'paymentcloud': {
    ...
    steps: [
      ...
      { title: 'Why Some Campaigns Take Longer to Ship', description: 'PaymentCloud holds 10% of the creator\'s gross campaign revenue in escrow for 180 days as protection against chargebacks. This applies to most funded campaigns. For you as a backer this changes nothing — your card is charged the full pledge amount as agreed — but it means the creator may have less working capital for fulfillment in the first six months. If a chargeback or dispute arises during this window, PaymentCloud can use the reserve to refund affected backers without going after the creator first.', tip: 'This is a creator-side protection. Your pledge experience and refund rights are unaffected.' },
    ]
  },
  'paypal': {
