    ...
    content: [
      {
        ...
        items: [
          ...
          "Payment information: processed securely through PayPal, DivinityCoin, or Whop (we never store card numbers)",
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          "Payment processors (PayPal, DivinityCoin, Whop) for secure transaction handling",
