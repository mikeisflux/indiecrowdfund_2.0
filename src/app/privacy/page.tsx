    ...
    content: [
      {
        ...
        items: [
          ...
          "Payment information: processed securely through PayPal, Divinity Payments, or Whop (we never store card numbers)",
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          "Payment processors (PayPal, Divinity Payments, Whop) for secure transaction handling",
