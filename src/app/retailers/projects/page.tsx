      ...
      setProjects([
        {
          ...
          rewards: [
            { id: "r1", title: "Single Copy", amount: 25, retailerPrice: 12.50 },
            { id: "r2", title: "Collector's Edition", amount: 45, retailerPrice: 22.50 },
          ],
          creator: { name: "Stellar Comics" },
        },
        {
          id: "2",
          ...
          daysLeft: 22,
          retailerDiscount: 50,
          retailerMinQuantity: 3,
          retailerMaxQuantity: 50,
          rewards: [
            { id: "r3", title: "Paperback", amount: 20, retailerPrice: 10 },
            { id: "r4", title: "Hardcover", amount: 35, retailerPrice: 17.50 },
          ],
          creator: { name: "Night Terrors Press" },
        },
        {
          id: "3",
          ...
          daysLeft: 8,
          retailerDiscount: 50,
          retailerMinQuantity: 10,
          retailerMaxQuantity: null,
          rewards: [
            { id: "r5", title: "Standard Issue", amount: 20, retailerPrice: 10 },
            { id: "r6", title: "Variant Cover", amount: 30, retailerPrice: 15 },
          ],
          creator: { name: "Future Comics" },
        },
        {
          id: "4",
          ...
          retailerDiscount: 50,
          retailerMinQuantity: 5,
          retailerMaxQuantity: 25,
          rewards: [
            { id: "r7", title: "Standard Edition", amount: 50, retailerPrice: 25 },
            { id: "r8", title: "Deluxe Edition", amount: 85, retailerPrice: 42.50 },
          ],
          creator: { name: "Maya Chen Art" },
        },
        {
          id: "5",
          ...
          retailerDiscount: 50,
          retailerMinQuantity: 3,
          retailerMaxQuantity: 30,
          rewards: [
            { id: "r9", title: "Box Set", amount: 75, retailerPrice: 37.50 },
            { id: "r10", title: "Signed Box Set", amount: 125, retailerPrice: 62.50 },
          ],
          creator: { name: "Brass & Gears Publishing" },
        },
        {
          id: "6",
          ...
          retailerDiscount: 50,
          retailerMinQuantity: 5,
          retailerMaxQuantity: 75,
          rewards: [
            { id: "r11", title: "Standard", amount: 30, retailerPrice: 15 },
            { id: "r12", title: "Premium", amount: 55, retailerPrice: 27.50 },
          ],
          creator: { name: "Shadow Lane Comics" },
        },
      ]);
      setTotalPages(3);
    } finally {
