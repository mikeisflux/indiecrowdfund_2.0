...
// Legacy project page - uses slug-only URLs for existing projects
export default function ProjectPage() {
  ...
  // Build the project URL path for legacy slug-only format
  const projectPath = `/projects/${slug}`;

  // Fetch project data using the slug-only API
  useEffect(() => {
    async function fetchProject() {
      ...
      try {
        ...
        // Use the slug-only API for legacy URLs
