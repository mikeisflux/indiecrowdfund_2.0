...
const backerQuestionSchema = z.object({
  ...
  displayType: z.string().optional().nullable(),
...
export async function GET(
  ...
  try {
    ...
    projectsSurveyBackerQuestionsLogger.error({ err: formatError(error) }, "Error fetching backer questions:");
...
export async function POST(
  ...
  try {
    ...
    // Auto-create survey if it doesn't exist. Use upsert instead of
    // findUnique+create so two concurrent POSTs don't race and P2002
    // on the `projectId @unique` constraint.
    ...
    projectsSurveyBackerQuestionsLogger.error({ err: formatError(error) }, "Error creating backer question:");
    return NextResponse.json(
...
export async function PUT(
  ...
  try {
    ...
    projectsSurveyBackerQuestionsLogger.error({ err: formatError(error) }, "Error updating backer question:");
    return NextResponse.json(
...
export async function DELETE(
  ...
  try {
    ...
    projectsSurveyBackerQuestionsLogger.error({ err: formatError(error) }, "Error deleting backer question:");
    return NextResponse.json(
