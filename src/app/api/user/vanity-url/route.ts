...
export async function GET() {
  try {
    ...
    userVanityUrlLogger.error({ err: formatError(error) }, "Vanity URL fetch error:");
    return NextResponse.json(
...
export async function POST(request: Request) {
  try {
    ...
    userVanityUrlLogger.error({ err: formatError(error) }, "Vanity URL set error:");
    return NextResponse.json(
...
export async function PUT(request: Request) {
  try {
    ...
    userVanityUrlLogger.error({ err: formatError(error) }, "Vanity URL check error:");
    return NextResponse.json(
