          ...
          <Card className="bg-card border-border">
            ...
            <CardContent className="space-y-6">
              ...
              {(() => {
                ...
                //   PayPal:    3.49% + $0.49
                //   Divinity:  3% + $0.30
                //   Whop:      3.5% + $0.37 (US cards; 2.7% payment
                //              processing + 0.8% orchestration + $0.30
                //              fixed + $0.07 Radar)
