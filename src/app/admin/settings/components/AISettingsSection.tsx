...
import { AISettings, SettingsSectionProps } from "./types";

interface AISettingsSectionProps extends SettingsSectionProps<AISettings> {
  onSave: () => void;
  aiTestResults: { openai: string; anthropic: string };
  onTestOpenAI: () => void;
          ...
          <div className="flex items-center justify-between rounded-lg border p-4">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                onChange({ ...settings, openaiEnabled: checked })
              }
            />
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <SecureKeyInput
                ...
                onChange={(value) => onChange({ ...settings, openaiApiKey: value })}
                onSave={onSave}
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) => onChange({ ...settings, openaiModel: v })}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="flex items-center justify-between rounded-lg border p-4">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    onChange({ ...settings, autoTagging: checked })
                  }
                />
              </div>
              <div className="flex items-center justify-between rounded-lg border p-4">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    onChange({ ...settings, marketingCopy: checked })
                  }
                />
              </div>
            </div>
        ...
        <CardContent className="space-y-6">
          <div className="flex items-center justify-between rounded-lg border p-4">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                onChange({ ...settings, anthropicEnabled: checked })
              }
            />
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <SecureKeyInput
                ...
                onChange={(value) => onChange({ ...settings, anthropicApiKey: value })}
                onSave={onSave}
              ...
              <p className="text-xs text-zinc-500">
                Get your API key from <a href="https://console.anthropic.com" target="_blank" rel="noopener noreferrer" className="text-violet-600 hover:underline">console.anthropic.com</a>
              </p>
            </div>
            <div className="space-y-2">
              <Label>Model</Label>
              <Select
                ...
                onValueChange={(v) => onChange({ ...settings, anthropicModel: v })}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="flex items-center justify-between rounded-lg border p-4">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-zinc-500">Automatically review projects for policy violations</p>
                </div>
                <Switch
                  checked={settings.contentModeration}
                  onCheckedChange={(checked) =>
                    onChange({ ...settings, contentModeration: checked })
                  }
                />
              </div>
              <div className="flex items-center justify-between rounded-lg border p-4">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-zinc-500">AI-powered fraud risk assessment</p>
                </div>
                <Switch
                  checked={settings.fraudDetection}
                  onCheckedChange={(checked) =>
                    onChange({ ...settings, fraudDetection: checked })
                  }
                />
              </div>
            </div>
