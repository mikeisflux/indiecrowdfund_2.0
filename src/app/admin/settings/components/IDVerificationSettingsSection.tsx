...
import { IDVerificationSettings, SettingsSectionProps } from "./types";

interface IDVerificationSettingsSectionProps extends SettingsSectionProps<IDVerificationSettings> {
  onSave: () => void;
}

export function IDVerificationSettingsSection({
  settings,
  onChange,
  onSave,
}: IDVerificationSettingsSectionProps) {
  return (
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <SecureKeyInput
                  ...
                  onChange={(value) =>
                    onChange({ ...settings, secretKey: value })
                  }
                  onSave={onSave}
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    onChange({ ...settings, callbackUrl: e.target.value })
                  }
