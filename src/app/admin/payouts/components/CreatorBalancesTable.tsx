                          ...
                          {creator.projectCount > 0 ? (
                            <div>
                              ...
                              {creator.projects.slice(0, 2).map((p) => (
                                <p key={p.id} className="text-xs text-muted-foreground truncate max-w-[200px]">
                                  {p.title} ({p.status})
                                </p>
                              ))}
                              {creator.projects.length > 2 && (
                                <p className="text-xs text-muted-foreground">+{creator.projects.length - 2} more</p>
                              )}
                            </div>
                          ) : (
                ...
                <div key={creator.id} className="p-4 space-y-3">
                  ...
                  {creator.projectCount > 0 && (
                    <div className="text-xs text-muted-foreground space-y-0.5">
                      ...
                      {creator.projects.length > 2 && (
                        <p className="text-muted-foreground">+{creator.projects.length - 2} more</p>
                      )}
                    </div>
                  )}
                  ...
                  {/* Financials row */}
                  <div className="flex items-center justify-between gap-2 rounded-lg bg-muted/50 dark:bg-zinc-800/50 px-3 py-2">
                    <div className="text-center">
                      <p className="text-[10px] uppercase tracking-wide text-muted-foreground mb-0.5">Project Earnings</p>
