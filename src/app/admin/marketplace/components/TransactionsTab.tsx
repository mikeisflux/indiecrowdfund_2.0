                  ...
                  <tr key={tx.id} className="hover:bg-muted/30">
                    ...
                    <td className="px-4 py-3 text-center">
                      <Badge variant="outline" className="text-xs">
                        {tx.paymentProcessor === "STRIPE" ? "Stripe" : tx.paymentProcessor === "DIVINITYCOIN" ? "Divinity Payments" : tx.paymentProcessor === "PAYPAL" ? "PayPal" : tx.paymentProcessor === "WHOP" ? "Whop" : tx.paymentProcessor}
                      </Badge>
                    </td>
                    <td className="px-4 py-3 text-center">
