...
const categories = [
  ...
  { id: "payments", label: "Payments & Fees", icon: CreditCard, description: "Payment processing and grant administration fees" },
...
const faqData: Record<string, { question: string; answer: string }[]> = {
  backers: [
    { question: "What is the Grant Program?", answer: "IndieCrowdfund is a DBA of Divinity Comics Inc., a 501(c)(3) nonprofit. When you back a campaign, your contribution goes to our Grant Program, whose mission is to promote western comics and art. A small percentage covers the program's administrative and facilitation costs, and the remainder is awarded to the creator as a grant to make the project. You are backing the creation of the project, not purchasing a product — rewards are offered by creators and are not guaranteed. Learn more at /grant-program." },
  ...
  payments: [
    { question: "What are the fees?", answer: "We charge a 3% grant administration fee on all successfully funded projects, plus payment processing fees. With PayPal, total fees are ~6.5% (3% grant administration + 3.49% + $0.49/txn). With Divinity Payments, total fees are ~6.5% (3% partner + $0.30/txn + 3% grant administration). With Whop, fees are ~6.5% (3% grant administration + 3.5% + $0.37/txn Whop fee on US cards; international adds ~1% currency conversion). Creators choose their payment processor when setting up a project." },
    ...
    { question: "Are pledges tax-deductible?", answer: "No. Contributions made through the Grant Program are not tax-deductible. Consult your own tax advisor about your specific situation." },
  ...
  admin: [
    ...
    { question: "Can I delete my account?", answer: "Yes. Go to Dashboard → Settings → Privacy & Security and click \"Delete my account.\" You'll confirm with your password and by typing DELETE MY ACCOUNT. For backers this is immediate and permanent: uncharged pledges are cancelled, you forfeit any rewards you're owed, creators are released from fulfilling them, and you lose access to backed projects. If you have ever taken a campaign live, deletion instead goes to our team for review — and we can't approve it while any backer on your campaigns is still unfulfilled, since deleting would release you from shipping what they paid for. Mark every backer shipped or delivered first. Prelaunch pages don't count; they take no money. Once deleted, your email address can't be reused for a new account." },
