...
const faqData: Record<string, { question: string; answer: string }[]> = {
  ...
  payments: [
    { question: "What are the platform fees?", answer: "We charge a 3% platform fee on all successfully funded projects, plus payment processing fees. With PayPal, total fees are ~6% (3% platform + ~3% processing). With DivinityCoin, total fees are ~6% (3% platform + 3% partner fee). With Whop, fees are ~6% (3% platform + ~3% Whop fee). Creators choose their payment processor when setting up a project." },
