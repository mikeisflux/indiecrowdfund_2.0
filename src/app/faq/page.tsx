...
const faqData: Record<string, { question: string; answer: string }[]> = {
  ...
  payments: [
    ...
    { question: "When do creators receive their funds?", answer: "For Stripe payments, we use Stripe Connect so payouts start as soon as the campaign is funded, though it can take up to 14 days depending on if you have a new account with Stripe. For DivinityCoin payments, a settlement will be applied to your checking account within 14 business days after the campaign ends." },
