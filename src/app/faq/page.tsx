...
const faqData: Record<string, { question: string; answer: string }[]> = {
  ...
  payments: [
    { question: "What are the platform fees?", answer: "We charge a 3% platform fee on all successfully funded projects, plus payment processing fees. With PayPal, total fees are ~6% (3% platform + ~3% processing). With DivinityCoin, total fees are ~9% (3% platform + 6% partner fee). With Whop, fees vary by plan. Creators choose their payment processor when setting up a project." },
