...
const faqData: Record<string, { question: string; answer: string }[]> = {
  ...
  payments: [
    { question: "What are the platform fees?", answer: "We charge a 5% platform fee on successfully funded projects, plus payment processing fees (2.9% + $0.30 for Stripe, or 10-15% for CCBill for adult content)." },
    { question: "Which payment methods are accepted?", answer: "We accept all major credit cards, debit cards, and select digital payment methods through our payment processors Stripe and CCBill." },
    { question: "What is Stripe vs CCBill?", answer: "Stripe is our standard payment processor with lower fees (2.9% + $0.30), recommended for most projects. CCBill is required for adult or high-risk content and has higher fees (10-15%) but specializes in age verification and compliance." },
    { question: "Is the platform NSFW-friendly?", answer: "Yes, we support adult content creators through our CCBill integration with proper age verification. Creators must declare adult content during project setup and use CCBill as their payment processor." },
    { question: "When do creators receive their funds?", answer: "Funds are transferred within 14 days after successful campaign completion. The exact timing depends on the payment processor and bank processing times." },
  ...
  security: [
    { question: "How is my payment information protected?", answer: "All payments are processed through PCI-compliant payment processors (Stripe and CCBill). We never store your full credit card details on our servers. All data transmission is encrypted using TLS." },
