...
const faqData: Record<string, { question: string; answer: string }[]> = {
  ...
  payments: [
    ...
    { question: "Which payment methods are accepted?", answer: "We accept all major credit cards, debit cards, Apple Pay, and Google Pay via Stripe. Backers can also use DivinityCoin credits, which they purchase in advance and can use across multiple creator platforms." },
    ...
    { question: "When is my card charged?", answer: "For Stripe payments, your card is only charged when a campaign successfully reaches its funding goal. For DivinityCoin, credits are purchased in advance and captured when the campaign funds successfully." },
    { question: "What if my payment fails?", answer: "If your Stripe payment fails when the campaign funds, we automatically retry up to 3 times over 9 days (once every 3 days) before marking the pledge as failed. DivinityCoin credits are pre-funded, so payment failures don't occur." },
