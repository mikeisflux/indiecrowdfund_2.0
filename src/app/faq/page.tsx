...
const faqData: Record<string, { question: string; answer: string }[]> = {
  ...
  payments: [
    ...
    { question: "Which payment methods are accepted?", answer: "We accept all major credit cards, debit cards, Apple Pay, and Google Pay via Stripe. Creators can also choose DivinityCoin as their payment processor, which accepts Visa, Mastercard, Amex, and Discover. Both options allow you to pay with your credit or debit card at checkout." },
    ...
    { question: "When is my card charged?", answer: "For campaigns still working toward their goal, your card is saved and only charged if the project reaches its funding goal. For campaigns that have already reached their goal, your card is charged immediately. This applies to both Stripe and DivinityCoin payment processors." },
