...
const faqData: Record<string, { question: string; answer: string }[]> = {
  ...
  payments: [
    { question: "What are the platform fees?", answer: "We charge a 3% platform fee on all successfully funded projects, plus payment processing fees. With Mentom Payments, total fees are ~7.5% (4.5% + $0.13/txn Mentom Payments + 3% platform). With PayPal, total fees are ~6.5% (3% platform + 3.49% + $0.49/txn). With DivinityCoin, total fees are ~6.5% (3% partner + $0.30/txn + 3% platform). With Whop, fees are ~6% (3% platform + ~3% Whop fee). Creators choose their payment processor when setting up a project." },
    { question: "Which payment methods are accepted?", answer: "We accept all major credit cards and debit cards via PayPal. Creators can also choose Mentom Payments, DivinityCoin, or Whop as their payment processor — all accept Visa, Mastercard, Amex, and Discover. All options allow you to pay with your credit or debit card at checkout." },
    { question: "What is Mentom Payments?", answer: "Mentom Payments is a high-risk friendly merchant account on the NMI payment gateway used by some creators on IndieCrowdfund. When you back a project that uses Mentom Payments, you simply enter your credit or debit card at checkout. Your card is tokenized in your browser via Collect.js — IndieCrowdfund servers never see your full card number. Supports all content types including NSFW/adult." },
    { question: "What is DivinityCoin?", answer: "DivinityCoin is an alternative payment sub-processor that some creators use on IndieCrowdfund. When you back a project that uses DivinityCoin, you simply enter your credit or debit card at checkout — just like any other online purchase. It is NOT a cryptocurrency, wallet, or token system. DivinityCoin supports all content types including NSFW/adult projects." },
    { question: "What is Whop?", answer: "Whop is an additional payment processor available to creators on IndieCrowdfund. Like DivinityCoin, you simply enter your credit or debit card at checkout when backing a project that uses Whop. It is a standard card payment processor, not a wallet or token system." },
    { question: "When is my card charged?", answer: "It depends on the campaign type. For 'All or Nothing' campaigns still working toward their goal, your card is only charged if the project reaches its funding goal. For 'Keep It All' campaigns, your card is charged immediately when you pledge — the creator keeps all funds regardless of the goal. Campaigns that have already reached their goal also charge immediately. This applies across all payment processors (Mentom Payments, PayPal, DivinityCoin, and Whop)." },
    ...
    { question: "When do creators receive their funds?", answer: "For Stripe payments, we use Stripe Connect so payouts start as soon as the campaign is funded, though it can take up to 14 days depending on if you have a new account with Stripe. For DivinityCoin payments, a settlement will be applied to the creator's bank account within 14 business days after the campaign ends." },
