...
const faqData: Record<string, { question: string; answer: string }[]> = {
  ...
  payments: [
    { question: "What are the platform fees?", answer: "We charge a 3% platform fee on all successfully funded projects, plus payment processing fees. With PaymentCloud, total fees are ~7.5% (4.5% + $0.13/txn PaymentCloud + 3% platform). With PayPal, total fees are ~6.5% (3% platform + 3.49% + $0.49/txn). With DivinityCoin, total fees are ~6.5% (3% partner + $0.30/txn + 3% platform). With Whop, fees are ~6% (3% platform + ~3% Whop fee). Creators choose their payment processor when setting up a project." },
    { question: "Which payment methods are accepted?", answer: "We accept all major credit cards and debit cards via PayPal. Creators can also choose PaymentCloud, DivinityCoin, or Whop as their payment processor — all accept Visa, Mastercard, Amex, and Discover. All options allow you to pay with your credit or debit card at checkout." },
    { question: "What is PaymentCloud?", answer: "PaymentCloud is a high-risk friendly merchant account on the NMI payment gateway used by some creators on IndieCrowdfund. When you back a project that uses PaymentCloud, you simply enter your credit or debit card at checkout. Your card is tokenized in your browser via Collect.js — IndieCrowdfund servers never see your full card number. Supports all content types including NSFW/adult." },
