...
const faqData: Record<string, { question: string; answer: string }[]> = {
  ...
  payments: [
    { question: "What are the platform fees?", answer: "We charge a 3% platform fee on successfully funded projects, plus payment processing fees. With Stripe, total fees are approximately 6% (2.9% + $0.30 per transaction). With DivinityCoin, the total is approximately 9% (6% partner fee + 3% platform fee)." },
    { question: "Which payment methods are accepted?", answer: "We accept all major credit cards, debit cards, Apple Pay, Google Pay via Stripe. Backers can also use DivinityCoin credits, which they purchase in advance and can use across multiple creator platforms." },
    { question: "What is DivinityCoin?", answer: "DivinityCoin is a universal credit system that allows backers to purchase credits in advance, then use those credits to back campaigns on IndieCrowdfund and other partner platforms. It offers backers flexibility while providing creators with secure, pre-funded payments." },
    { question: "When is my card charged?", answer: "For Stripe payments, your card is only charged when a campaign successfully reaches its funding goal. For DivinityCoin, credits are purchased in advance and held until you redeem them on a campaign. Credits are captured when the campaign funds successfully." },
    ...
    { question: "When do creators receive their funds?", answer: "For Stripe payments, funds are transferred within 14 days after successful campaign completion. For DivinityCoin payments, settlements occur on a weekly or monthly basis based on the creator's settings, with funds wired to their bank account." },
