          ...
          <div className="flex-1 min-w-0">
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">
                          The Digital Shop offers completed works from verified indie creators. Buy once, own forever, and read on any device.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mb-6 rounded-lg border border-primary/30 bg-primary/10 p-4">
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">
                          All payments are processed securely through Divinity Payments, PayPal, or Whop. As soon as you pay, your book lands in your Downloads tab — no waiting.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="mt-16">
              <SectionHeader
                ...
                description="Common questions about the Digital Shop."
              />
