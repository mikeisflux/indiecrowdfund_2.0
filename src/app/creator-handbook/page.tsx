...
const tabContent: Record<string, { title: string; description: string; fields: FieldInfo[] }> = {
  ...
  'payment': {
    ...
    fields: [
      ...
      { name: 'DivinityCoin', required: false, description: 'Alternative payment sub-processor where backers enter their credit or debit card at checkout. DivinityCoin handles payment processing seamlessly — backers see a secure card payment form with Visa, Mastercard, Amex, and Discover logos.', tips: '3% platform fee + 6% partner fee ≈ 9% total. Supports NSFW/adult content that standard processors may not allow. Settlement to your bank account within 14 business days.' },
      ...
      { name: 'Payment Processor Selection', required: true, description: 'Choose your payment processor during project setup. First select your campaign funding model (All or Nothing vs Keep It All), then pick your processor. You can switch processors even on live campaigns.', tips: 'Compare fees: PayPal ~6.5%, DivinityCoin ~9%, Whop ~6%. All or Nothing: PayPal or DivinityCoin. Keep It All: PayPal, DivinityCoin, or Whop. NSFW projects must use Keep It All + DivinityCoin or Whop.' },
