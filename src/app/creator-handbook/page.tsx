...
const tabContent: Record<string, { title: string; description: string; fields: FieldInfo[] }> = {
  ...
  'marketplace': {
    ...
    fields: [
      ...
      { name: 'Platform Fee', required: false, description: 'Marketplace uses PayPal: 3% platform fee + PayPal fees (3.49% + $0.49/txn). NSFW content uses DivinityCoin instead.', tips: 'Example: $10 sale → you receive ~$9.30. Add your bank account in Dashboard > Settings > Payments to receive payouts directly to your bank.' },
