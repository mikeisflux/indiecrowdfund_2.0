...
const tabContent: Record<string, { title: string; description: string; fields: FieldInfo[] }> = {
  'grant-program': {
    ...
    description: 'IndieCrowdfund is a DBA of Divinity Comics Inc., a 501(c)(3) nonprofit. Campaign funding runs through our Grant Program: backers contribute to the program, and funds are awarded to you as a grant to make your project. Here is what that means for you as a creator.',
    fields: [
      { name: 'How the money flows', required: false, description: 'Backers contribute through our payment processors; contributions go to IndieCrowdfund (a DBA of Divinity Comics Inc.) in support of the Grant Program. A small percentage is retained to cover the administrative and facilitation costs of running the program, and the remainder is awarded to you as a grant.', tips: 'The percentages are disclosed during project setup — nothing changes about how you build or price your campaign.' },
  ...
  'rewards': {
    ...
    fields: [
      ...
      { name: 'Reward Image', required: false, description: 'A photo or mockup of what backers receive at this tier. Shown on the reward card. Newer campaigns display these as tall 2:3 portraits, sized for comic covers — upload around 1000 x 1500px. Campaigns launched before the new layout show them landscape at 933 x 621px. The builder tells you which one your campaign wants and previews the exact crop.', tips: 'Even a low-fi mockup outperforms no image. Use Photoshop, Procreate, or even a phone photo. Match the shape the builder shows you — a landscape image in a portrait card loses its edges.' },
