...
const tabContent: Record<string, { title: string; description: string; fields: FieldInfo[] }> = {
  ...
  'payment': {
    ...
    fields: [
      ...
      { name: 'PaymentCloud', required: false, description: 'High-risk friendly merchant account on the NMI gateway. Backers enter their card directly on your campaign page — the card is securely tokenized in the browser via Collect.js (PAN never touches our servers) and only charged when the campaign hits its goal. Supports both All or Nothing and Keep It All.', tips: '4.5% + $0.13/txn PaymentCloud + 3% platform fee ≈ 7.5% total. Supports all content types. Funds settle to your bank account on the merchant account schedule.' },
