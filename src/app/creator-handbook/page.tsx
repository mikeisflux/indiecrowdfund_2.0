...
const tabContent: Record<string, { title: string; description: string; fields: FieldInfo[] }> = {
  ...
  'payment': {
    ...
    fields: [
      ...
      { name: 'Whop Processor', required: false, description: 'A third processor option, similar to PayPal in user experience but with different content policy and fee structure. Supports both All-or-Nothing and Keep-It-All. Apple Pay and Google Pay supported where available.', tips: 'Whop\'s fees and policies differ from the others — check the Settings → Payments section for current rates. Pick Whop if their policies fit your project better than the alternatives.' },
  ...
  'marketplace': {
    ...
    fields: [
      ...
      { name: 'Platform & Processor Fees', required: false, description: 'Marketplace uses PayPal by default: 3% platform fee + PayPal\'s ~3.49% + $0.49/txn. NSFW or restricted content uses DivinityCoin or Whop instead with similar combined effective rates.', tips: 'Example: $10 sale → you receive ~$9.30 after fees. Add your bank account in Dashboard → Settings → Payments to receive payouts directly.' },
