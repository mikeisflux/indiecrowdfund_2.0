...
const tabContent: Record<string, { title: string; description: string; fields: FieldInfo[] }> = {
  ...
  'payment': {
    ...
    fields: [
      ...
      { name: 'Payment Processor Selection', required: true, description: 'Choose your payment processor during project setup. First select your campaign funding model (All or Nothing vs Keep It All), then pick your processor. You can switch processors even on live campaigns.', tips: 'Compare fees: PayPal ~6.5%, DivinityCoin ~6.5%, Whop ~6%. All or Nothing: PayPal or DivinityCoin. Keep It All: PayPal, DivinityCoin, or Whop. NSFW projects must use Keep It All + DivinityCoin or Whop.' },
