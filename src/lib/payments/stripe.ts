 ...
 */
async function safeCancelSetupIntent(stripeClient: Stripe, setupIntentId: string): Promise<boolean> {
  try {
 ...
 * Prevents errors from trying to cancel succeeded/canceled intents
 */
async function safeCancelPaymentIntent(stripeClient: Stripe, paymentIntentId: string): Promise<boolean> {
  try {
